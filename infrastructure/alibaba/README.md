# Alibaba Cloud example (TODO)

Example for a taito zone located in Alibaba Cloud. Configure settings in `taito-config.sh` and then create the zone by running `taito zone apply`.
